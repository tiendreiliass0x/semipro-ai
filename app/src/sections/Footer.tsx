    ...
    <footer className="relative mt-24 py-20 px-4 border-t border-cyan-500/20 bg-gradient-to-b from-[#05080f] to-black font-hero-sans">
      <div className="max-w-6xl mx-auto">
        <div className="text-center text-sm text-gray-400 mb-16">
          Craft your first polished short film with <span className="text-cyan-200">YenengaLabs Director Studio</span>.
        </div>
          ...
          <div>
            ...
            <div className="flex gap-3 mt-6">
              {[Twitter, Instagram, Disc3, Github, Globe2, Youtube].map((Icon, index) => (
                <a
                  key={index}
                  href={Icon === Globe2 ? 'https://yenengalabs.com' : '#'}
                  target={Icon === Globe2 ? '_blank' : undefined}
                  rel={Icon === Globe2 ? 'noreferrer' : undefined}
        ...
        <div className="mt-14 pt-6 border-t border-gray-800 text-sm text-gray-500 flex flex-wrap items-center justify-between gap-3">
          <p>&copy; {new Date().getFullYear()} YenengaLabs. All rights reserved.</p>
