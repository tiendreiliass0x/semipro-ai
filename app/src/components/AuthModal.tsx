        ...
        <div className="w-full">
          <nav className="w-full px-4 md:px-6 xl:px-8 py-2.5 xl:py-3 flex items-center justify-between gap-4 xl:gap-8 text-white">
            <button className="inline-flex items-center gap-2 text-sm md:text-base xl:text-lg font-semibold tracking-wide">
              <img src="/yenengalabs-logo.png" alt="YenengaLabs logo" className="w-7 h-7 rounded object-cover" /> YenengaLabs
            </button>

            {!isAuthenticated && (
              <div className="hidden md:flex items-center gap-8 xl:gap-12 text-sm xl:text-base text-white/85">
                <a href="#hero" className="hover:text-white transition">Home</a>
                <a href="#proof" className="hover:text-white transition">Process</a>
